...
class InputField extends React.Component {
  constructor(props) {
    super(props);
    const { classes, options, id, label, multiple, value, defaultValue } = props;
    this.classes = classes;
    this.key = id + "-" + label;
    this.useOptions = Array.isArray(options);

    this.state = {
      showPasswd: false,
      inputValue: multiple ? "" : value,
      options: this.useOptions ? options : [],
      value: value ? value : defaultValue ? defaultValue : multiple ? [] : "",
    };
  ...
  render() {
    ...
    const { showPasswd, inputValue, options, value } = this.state;
        ...
        <div style={{ display: "flex", flexFlow: "row wrap" }}>
          ...
          {this.useOptions ? (
            <Autocomplete
              ...
              getOptionLabel={getOptionLabel || ((o) => o.toString())}
            ...
            <TextField
              value={value}
              onKeyUp={(e) => (e.key == "Escape" ? this.setState({ value: "" }) : null)}
              fullWidth={fullWidth}
              error={error}
